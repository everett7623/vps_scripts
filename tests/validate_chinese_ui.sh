...
require_text "vps.sh" "论坛推荐"
require_text "vps.sh" "https://nodeloc.com"
require_text "vps.sh" "VPS 推荐"
require_text "vps.sh" "https://vpsknow.com"
require_text "vps.sh" "博客推荐"
require_text "vps.sh" "https://seedloc.com"
require_text "vps.sh" "模块路径"
require_text "vps.sh" "运行模式"
require_text "vps.sh" "安全校验"
require_text "vps.sh" "│"
require_text "vps.sh" "#####"
...
require_text "scripts/system_tools/system_info.sh" "系统盘点"
require_text "scripts/system_tools/install_deps.sh" "正在刷新软件包元数据"
require_text "scripts/system_tools/install_deps.sh" "软件包安装"
require_text "scripts/system_tools/update_system.sh" "正在备份关键配置文件"
require_text "scripts/system_tools/update_system.sh" "系统更新"
